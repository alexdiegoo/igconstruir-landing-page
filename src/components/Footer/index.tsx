...
function Footer() {
    return (
        <footer className="bg-bg-card mt-60">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">IG Construir</a>. Todos os direitos reservados.
                </span>
